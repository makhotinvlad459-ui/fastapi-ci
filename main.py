...
@app.get("/recipes/{recipe_id}", response_model=RecipeDetail, summary="Детали рецепта", tags=["Рецепты"])
...
@app.post("/recipes", response_model=RecipeDetail, status_code=201, summary="Создать рецепт", tags=["Рецепты"])
